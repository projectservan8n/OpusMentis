      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-card shadow-sm rounded-lg p-8 border">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">Data Sharing and Third Parties</h2>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              <a href="mailto:team@opusautomations.com" className="text-primary hover:text-primary/80">
